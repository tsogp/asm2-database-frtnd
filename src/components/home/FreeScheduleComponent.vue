  ...
  <div>
    ...
    <div v-for="schedule in schedules" :key="schedule.staff_id">
      ...
      <div class="flex flex-row flex-wrap gap-2 my-2">
        <Tag
          :severity="isSelected(schedule.schedule_date, 1) ? 'success' : 'info'"
          value="09:00-10:00"
          v-if="schedule['09:00-10:00'] === 'available'"
          class="cursor-pointer"
          @click="selectSlot(schedule.schedule_date, 1)"
        />
        <Tag
          :severity="isSelected(schedule.schedule_date, 2) ? 'success' : 'info'"
          value="10:00-11:00"
          v-if="schedule['10:00-11:00'] === 'available'"
          class="cursor-pointer"
          @click="selectSlot(schedule.schedule_date, 2)"
        />
        <Tag
          :severity="isSelected(schedule.schedule_date, 3) ? 'success' : 'info'"
          value="11:00-12:00"
          v-if="schedule['11:00-12:00'] === 'available'"
          class="cursor-pointer"
          @click="selectSlot(schedule.schedule_date, 3)"
        />
        <Tag
          :severity="isSelected(schedule.schedule_date, 4) ? 'success' : 'info'"
          value="12:00-13:00"
          v-if="schedule['12:00-13:00'] === 'available'"
          class="cursor-pointer"
          @click="selectSlot(schedule.schedule_date, 4)"
        />
        <Tag
          :severity="isSelected(schedule.schedule_date, 5) ? 'success' : 'info'"
          value="13:00-14:00"
          v-if="schedule['13:00-14:00'] === 'available'"
          class="cursor-pointer"
          @click="selectSlot(schedule.schedule_date, 5)"
        />
        <Tag
          :severity="isSelected(schedule.schedule_date, 6) ? 'success' : 'info'"
          value="14:00-15:00"
          v-if="schedule['14:00-15:00'] === 'available'"
          class="cursor-pointer"
          @click="selectSlot(schedule.schedule_date, 6)"
        />
        <Tag
          :severity="isSelected(schedule.schedule_date, 7) ? 'success' : 'info'"
          value="15:00-16:00"
          v-if="schedule['15:00-16:00'] === 'available'"
          class="cursor-pointer"
          @click="selectSlot(schedule.schedule_date, 7)"
        />
        <Tag
          :severity="isSelected(schedule.schedule_date, 8) ? 'success' : 'info'"
          value="16:00-17:00"
          v-if="schedule['16:00-17:00'] === 'available'"
          class="cursor-pointer"
